...
public class Fellows_unrMsg extends ActionBarActivity implements AdapterView.OnItemClickListener{
    ...
    private android.os.Handler mhandler = new android.os.Handler() {
        ...
        to 绑定数据视图中的ID，与from组成对应关系)*/
                ...
                simpleAdapter = new SimpleAdapter(Fellows_unrMsg.this,datalist,R.layout.msglist,new String[]{"name","theme","date"},new int[]{R.id.textView_MsgList_name,R.id.textView_MsgList_theme,R.id.textView_MsgList_date});
                listView.setAdapter(simpleAdapter);
                listView.setOnItemClickListener(Fellows_unrMsg.this);
            }else{
                Toast.makeText(Fellows_unrMsg.this, "获取未读信息列表失败！", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        intent.setClass(Fellows_unrMsg.this, Fellows_RecMsg_Detail.class);
